...
export default function CustomerDetail() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-6xl mx-auto space-y-10">
      ...
      {/* Orders */}
      <Section title="Orders" data={customer?.orders || partner?.orders || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.orders || partner?.orders || []}
          loading={false}
      ...
      {/* Assets */}
      <Section title="Assets" data={customer?.assets || partner?.assets || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.assets || partner?.assets || []}
          loading={false}
      ...
      {/* Invoices */}
      <Section title="Invoices" data={customer?.invoices || partner?.invoices || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.invoices || partner?.invoices || []}
          loading={false}
      ...
      {/* Contracts */}
      <Section title="Contracts" data={customer?.contracts || partner?.contracts || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.contracts || partner?.contracts || []}
          loading={false}
      ...
      {/* Returns */}
      <Section title="Returns" data={customer?.returns || partner?.returns || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.returns || partner?.returns || []}
          loading={false}
      ...
      {/* Tickets */}
      <Section title="Support Tickets" data={customer?.tickets || partner?.tickets || []} navigate={navigate}>
        <DataTable
          columns={[
          ...
          data={customer?.tickets || partner?.tickets || []}
          loading={false}
