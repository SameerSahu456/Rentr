const BASE_URL = import.meta.env.VITE_DISTRIBUTOR_API_URL || '/api/distributor';

function getToken() {
  return localStorage.getItem('rentr_dist_token');
}

function setToken(token) {
  localStorage.setItem('rentr_dist_token', token);
}

function clearToken() {
  localStorage.removeItem('rentr_dist_token');
}
